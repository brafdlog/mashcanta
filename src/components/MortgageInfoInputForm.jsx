    ...
    render() {
        ...
        return (
            <div className={cx(styles.MortgageInfoInputFormContainer, className)}>
                ...
                >
                    <TableHeaderColumn columnClassName={styles.columnTd} className={styles.headerTd} dataField='order' isKey dataAlign='center'
                        hidden
                    />
                    <TableHeaderColumn columnClassName={styles.columnTd} className={styles.headerTd} dataField='amortizationType' dataAlign='center' width={'70'}
                        editable={this.amortizationTypeEditSettings} dataFormat={this.amortizationCellFormatter}
                    >
                        {str('amortizationType')}
                    </TableHeaderColumn>
                    <TableHeaderColumn columnClassName={styles.columnTd} className={styles.headerTd} dataField='loanAmount' dataFormat={formatWholeDollarAmount} dataAlign='center'
                        width={'80'}
                    >
                        {str('amount')}
                    </TableHeaderColumn>
                    <TableHeaderColumn columnClassName={styles.columnTd} className={styles.headerTd} dataField='numYears' dataAlign='center' width={'50'}>
                        {str('years')}
                    </TableHeaderColumn>
                    <TableHeaderColumn columnClassName={styles.columnTd} className={styles.headerTd} dataField='yearlyInterest' dataAlign='center' dataFormat={formatPrecent}
                        width={'50'}
                    >
                        {str('interest')}
                    </TableHeaderColumn>
